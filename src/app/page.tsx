...
/**
 * PROMOCIÓN A PORTADA (aprobada por el usuario).
 * La portada ahora redirige a la experiencia /archivo.
 *
 * REVERSA: restaurar el contenido original del starter:
 * ------------------------------------------------------------------
 * import { db } from "@/db";
 ...
 *           Server-rendered with Next.js after a successful PostgreSQL query
 *           through Drizzle.
 *         </p>
 *       </section>
 *     </main>
